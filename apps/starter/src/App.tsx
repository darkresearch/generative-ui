...
export default function App() {
  ...
  const handleTap = useCallback(() => {
    // Light haptic for responsive feel without being fatiguing on rapid taps
  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        {/* Centered Text - Tap to spin faster! */}
        <Pressable 
          style={styles.textContainer} 
          onPress={handleTap}
          accessibilityLabel="Tap to spin the star faster"
...
const styles = StyleSheet.create((theme) => ({
  ...
  textContainer: {
    ...
    padding: 16, // Larger touch target
  },
  title: {
    fontSize: 36,
